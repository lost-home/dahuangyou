...
namespace Prime31 {
    ...
    public class CharacterController2D : MonoBehaviour
    {
	    ...
	    public class CharacterCollisionState2D
	    {
            ...
            public GameObject aboveObject, belowObject, leftObject, rightObject;
            ...
            for (var i = 0; i < totalHorizontalRays; i++)
            {
                ...
                if (_raycastHit)
                {
                    ...
                    if (directionX == 1)
                    {
                        ...
                        collisionState.rightObject = _raycastHit.collider.gameObject;
                    }
                    else
                    {
                        collisionState.left = true;
                        collisionState.leftPoint = _raycastHit.point;
                        collisionState.leftObject = _raycastHit.collider.gameObject;
                    }
	    ...
	    bool handleHorizontalSlope( ref Vector2 deltaMovement, float angle )
	    {
		    ...
		    if( angle < slopeLimit )
		    {
			    ...
			    if( deltaMovement.y < jumpingThreshold )
			    {
                    ...
                    collisionState.belowObject = _raycastHit.collider.gameObject;
                }
		    }
		    ...
		    for( var i = 0; i < totalVerticalRays; i++ )
		    {
			    ...
			    if( _raycastHit )
			    {
				    ...
				    if( isGoingUp )
				    {
                        ...
                        collisionState.aboveObject = _raycastHit.collider.gameObject;
                    }
				    else
				    {
                        deltaMovement.y += _skinWidth;
