...
namespace RSG
{
    ...
    public interface IStateBuilder<T, TParent> where T : AbstractState, new()
    {
        ...
        IStateBuilder<State, IStateBuilder<T, TParent>> State(System.Enum stateName);
        ...
        where T : AbstractState, new()
    {
        ...
        public IStateBuilder<State, IStateBuilder<T, TParent>> State(System.Enum name)
        {
            return new StateBuilder<State, IStateBuilder<T, TParent>>(this, state, name.ToString());
        }
